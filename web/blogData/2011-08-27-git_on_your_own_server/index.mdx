...
export const meta = {
  ...
  description: "# Git on your own server 1. First, you create a git user account and a .ssh directory for the daemon user. 2. Set up an empty repository for them by running...",
