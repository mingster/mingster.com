...
export const meta = {
  title: "Debug by 蔡學鏞",
  description: "以下轉載自 Debug本文作者：蔡學鏞張貼日期：05/16/2002 Debug吃燒餅不免會掉芝麻，寫程式不免會有 bug。再怎麼高明的程式員，也不敢保證寫出來的程式不會有 bug。當發現程式有誤，bug 隱身其中時，就是 debugger 出動的時候了。越是高明的程式員，越是能夠靈巧地使用 debugger，讓...",
