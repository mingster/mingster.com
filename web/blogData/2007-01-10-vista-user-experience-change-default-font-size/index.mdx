...
export const meta = {
  ...
  description: "I'm using Vista in Transitional Chinese edition. It's cool to see MS releases a better and more \"Mac-like\" shell. For TC user, the new font \"正黑體\" is way...",
