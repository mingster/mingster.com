...
export const meta = {
  title: "C#基礎概念25問",
  description: "1.靜態變數和非靜態變數的區別？2.const 和 static readonly 區別？3.extern 是什麼意思？4.abstract 是什麼意思？5.internal 修飾符起什麼作用？6.sealed 修飾符是幹什麼的？7.override 和 overload 的區別？8.什麼是索引指示器？9.new...",
