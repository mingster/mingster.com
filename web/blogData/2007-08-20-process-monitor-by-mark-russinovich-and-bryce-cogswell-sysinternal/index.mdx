...
export const meta = {
  ...
  description: "SysInternal is been around since DOS date. And yet still active and hard core as they always are. Their recent production: Process Monitor, I'm adding it into...",
