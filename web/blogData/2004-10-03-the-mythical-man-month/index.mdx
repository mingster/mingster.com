...
export const meta = {
  ...
  description: "by Frederick P. Brooks (Paperback)Addison-Wesley Professional; 1st edition (August 2, 1995) Editorial Reviews Amazon.comThe classic book on the human elements...",
