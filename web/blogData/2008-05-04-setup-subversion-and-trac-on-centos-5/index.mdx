...
export const meta = {
  ...
  description: "Recently I set up a virtual server to use as a development machine. It runs on CentOS 5 and hosts several Subversion repositories with associated Trac...",
