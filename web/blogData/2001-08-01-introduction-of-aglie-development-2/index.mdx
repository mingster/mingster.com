...
export const meta = {
  ...
  description: "IntroductionI want to provide thorough information for the everyday coder - without the \"I want to sell you something so I have to look extra smart\"...",
