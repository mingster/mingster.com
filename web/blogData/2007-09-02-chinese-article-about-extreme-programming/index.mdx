...
export const meta = {
  ...
  description: "This is good intro in Chinese about XP programming. Finally there's more talk in Taiwan about iton a major IT publication. If you interested in xp, also check...",
