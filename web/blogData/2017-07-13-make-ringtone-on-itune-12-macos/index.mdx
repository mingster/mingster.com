...
export const meta = {
  ...
  description: "mac is so easy to use if you paid. Just now I want to make a ring tone for my own theme song originally from \"Flash Gordon\" movie. And learned that it's not...",
