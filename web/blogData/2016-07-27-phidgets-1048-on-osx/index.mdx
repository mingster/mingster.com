...
export const meta = {
  ...
  description: "update: 2017/07/05 After update macos to high sierra, phigets driver needs to be reinstalled. With latest version of Roastmaster, you can use latest Phigets...",
