...
export const meta = {
  ...
  description: "常常懶的煮syphon，就是為了那個很難洗乾靜的濾布。 受到台中黝脈咖啡年輕老闆的感召，我也來玩玩復古的： 應該說是『新古』，因為這個組合是現代的Hario TCA-3 + Cory玻璃濾芯。 這樣用，要注意沖煮時間要比布濾短很多。因為下流速度慢很多。 此外，粉不能磨超過刻度3 (小富士平刀)，要不然咖啡可能下不來。",
