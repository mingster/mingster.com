...
export const meta = {
  ...
  description: "2006/12/5 Triple play is focused on one of NGN killer application which integrates TV telephony, VOD/IPTV and web service over common platform of NGN. At ITU...",
