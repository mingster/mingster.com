...
export const meta = {
  ...
  description: "1. Check what is the new hard disk device name with \"fdisk -l\", it should be something like /dev/sda. You can easily identify which is the new drive by running...",
