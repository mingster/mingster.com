...
export const meta = {
  ...
  description: "Have you ever wanted to know how to easily synchronize the data between multiple servers automatically? rsync is the anwser. And here's some note. We will use...",
