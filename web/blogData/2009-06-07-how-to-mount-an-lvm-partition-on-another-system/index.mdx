...
export const meta = {
  ...
  description: "I ran into a Fedora box recently which after rebooting was unable to mount the root file system. Here's what I did to get this going: First I booted off the...",
