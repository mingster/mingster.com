...
export const meta = {
  title: "Mercury簡易改裝",
  description: "有同好有一樣的困擾 - 如何使用自己的data logging軟體，這篇紀錄我的簡易改裝。 ## Background [雲豆子 MERCURY roaster](https://www.facebook.com/cloudbeantech/) 烘豆機的設計是使用自行開發的軟體，來：1. 操控風門/火力; 2....",
