...
export const meta = {
  ...
  description: "update: So far the Raspberry Pi 3 is not powerful enough for me. It takes several minutes for a movie to start streaming a mp4 file to ATV in the same LAN. It...",
