...
export const meta = {
  ...
  description: "Synchronize the clocks is standard now-da-day. If you don't have NTP for some reason, here's how you set it up in CentOS. First Install the NTP Package on your...",
