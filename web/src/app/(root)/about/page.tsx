			...
			<div className="min-h-screen">
				...
				<Container className="font-minimal pt-0 bg-[url('/img/noise.147fc0e.gif')] bg-repeat dark:bg-none">
					<div className="min-h-screen flex flex-col font-minimal">
							...
							<div className="w-full max-w-xl space-y-10">
								<div className="space-y-8">
									<div>
										...
										<p className="text-base text-foreground">mingster.com</p>
									</div>
						...
						{/* Footer Links */}
						<footer className="w-full max-w-xl mx-auto px-4 pb-12">
							<nav className="flex flex-wrap gap-8 justify-center text-xs uppercase tracking-widest">
								<Link
									href="/contact"
